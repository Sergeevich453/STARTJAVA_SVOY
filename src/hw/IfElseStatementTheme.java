...
public class IfElseStatementTheme {
    ...
    public static void main(String [] args) {
        ...
        switch(1) {
            ...
            case 4:
                if ((letter >= 0 & letter <= 31) || (letter >= 32 & letter <= 42)
                        || (letter >= 58  & letter <= 64) || (letter >= 91  & letter <= 96)
                        || (letter >= 123  & letter <= 1000)) {
        ...
        double profitYear = (profitMonth1 + profitMonth2 + profitMonth3 + profitMonth4 + profitMonth5
                + profitMonth6 + profitMonth7 + profitMonth8 + profitMonth9 + profitMonth10 + profitMonth11
                + profitMonth12) / 12;
        if (profitYear > 0) {
